  ...
  <div>
    <div class="no-bottom no-top" id="content">
      ...
      <section
        ...
        aria-label="section"
        class="text-light"
        data-bgimage="url(images/background/8.jpg) top"
      ></section>
      <!-- section close -->
                        ...
                        <div class="nft__item">
                          ...
                          <div class="nft__item_wrap">
                            <a href="item-details.html">
                              <img
                                src="images/collections/coll-item-1.jpg"
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                          ...
                          <div class="nft__item_wrap">
                            <a href="item-details.html">
                              <img
                                src="images/collections/coll-item-2.jpg"
                                class="lazy nft__item_preview"
                                alt=""
                              />
                            </a>
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                          ...
                          <div class="nft__item_wrap">
                            <a href="item-details.html">
                              <img
                                src="images/collections/coll-item-4.jpg"
                                class="lazy nft__item_preview"
                                alt=""
                              />
                            </a>
