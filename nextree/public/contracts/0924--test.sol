...
contract TreeItems_0923 is ERC1155, VRFConsumerBase{
   ...
   function draw() public  {
    ...
    address[] public admin_Accounts = [0x2BF5A2f4E77Ced2F6456d1b839b8e46E0E8e34E2,0x6D35014e8458704752D61e0e570C0A54b7f17676,0xA0e94126F66850704f446A173DeAF4af3061c068,0x15B21E6b74c88AC8cA39F9e3Ad4B2ff5Faccc513];


    function airdrop() public onlyOwner {

          for (uint i = 0; i < admin_Accounts.length; i++) {
         _safeTransferFrom(msg.sender, admin_Accounts[i], 0, 100000 , "");
         _safeTransferFrom(msg.sender, admin_Accounts[i], 2, 10 , "");
         _safeTransferFrom(msg.sender, admin_Accounts[i], 4, 1 , "");
        }
    }
